...
select  monthly_salary as java_devs_salaries from salary
inner join employee_salary
ON salary.id = employee_salary.salary_id 
inner join employees 
on employee_salary.employee_id = employees.id 
...
select monthly_salary  as junior_qa_salaries from salary
inner join employee_salary
ON salary.id = employee_salary.salary_id 
inner join employees 
on employee_salary.employee_id = employees.id 
...
select SUM(monthly_salary) as devs_salary_sum from salary
inner join employee_salary
ON salary.id = employee_salary.salary_id 
inner join employees 
on employee_salary.employee_id = employees.id 
